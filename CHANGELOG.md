...
The release is intended to establish the first maintainable baseline for public GitHub review, Codex-assisted maintenance workflows, and future source adapter expansion.
